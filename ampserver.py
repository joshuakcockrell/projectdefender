...
class EnemyState(ServerStateObject):
    ...
    def update(self):
        ...
        if self.state == 'waiting':
            ...
            grid_position = mapgrid.convert_position_to_grid_position(self.position)
            center_grid_position = mapgrid.convert_position_to_grid_position(center_position)
        ...
        if self.state == 'attacking':
            ...
            self.target_position = mapgrid.convert_grid_position_to_position(target_center_grid_position)

            # if we have a new target
            if self.target_position != self.previous_target_position:
                self.state_changed = True
            vector_target_position = mapgrid.Vector(self.target_position)
            vector_position = mapgrid.Vector(self.position)
